...
void getBuckets(unsigned char *s, int64 *bkt, int64 n, int64 K, int64 cs, bool end) {
	int64 i, sum = 0;
...
void induceSAl(unsigned char *t, int64 *SA, unsigned char *s, int64 *bkt,
	int64 n, int64 K, int64 cs, int64 level) {
	int64 i, j;
...
void SA_IS(unsigned char *s, int64 *SA, int64 n, int64 K, int64 cs, int64 level) {
	...
	// compact all the sorted substrings int64o the first n1 items of s
	...
	if (name<n1) {
		SA_IS((unsigned char*)s1, SA1, n1, name - 1, sizeof(int64), level + 1);
	}
